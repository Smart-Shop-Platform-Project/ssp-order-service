...
resource "aws_iam_policy" "ssm_policy" {
  name        = "ssp-order-service-ssm-policy-${var.environment}"
  description = "Allows reading specific SSM parameters for the order service"
...
module "ecr" {
  ...
  repository_name = "ssp-order-service"
